...
export const paperDatabase: Paper[] = [
  ...
  },
  {
    ...
    year: 2024,
    description: "This research examines how artificial intelligence is influencing clinical decision-making processes and its potential implications for patient care and healthcare systems."
  },
  {
    id: "paper4",
    ...
    year: 2023,
    description: "This paper discusses the ethical implications of using AI in healthcare, addressing issues such as privacy, bias, and the doctor-patient relationship."
  },
  {
    id: "paper5",
    ...
    year: 2024,
    description: "This study explores the application of natural language processing techniques in analyzing and extracting information from electronic health records."
  },
  {
    id: "paper6",
    ...
    year: 2023,
    description: "This research presents a novel approach to patient risk stratification using predictive analytics and machine learning algorithms."
  },
  {
    id: "paper7",
    ...
    year: 2025,
    description: "This systematic review examines the current state and future prospects of robotics in minimally invasive surgical procedures."
  }
];
...
export function findPaper(query: string): Paper | undefined {
  ...
  return paperDatabase.find(
    paper => paper.id.toLowerCase() === lowercaseQuery || paper.title.toLowerCase().includes(lowercaseQuery)
  );
}